  ...
  define(function() {
    return function(env) {
      ...
      return {
        ...
        init: function(env) {
          var Backbone, Collection, Model, api, batch, core, easyXDM, exec, extractApiArgs, initialized, message, methodMap, models, onRemoteMessage, onRemoteReady, slice, sync, _;
          core = env.core;
