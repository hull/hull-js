...
(function() {
  ...
  define(['backbone', 'underscore'], function(Backbone, _) {
    var HullWidget, decamelize, default_datasources, slice, templates;
    ...
    HullWidget = (function(_super) {
      ...
      HullWidget.prototype.buildContext = function() {
        var dfd, keys, promises, ret, _ref,
          _this = this;
      ...
      HullWidget.prototype.actionHandler = function(e) {
        ...
        try {
          ...
          console.warn("Action to call: ", fn, this.actions);
